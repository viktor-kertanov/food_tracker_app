...
# Checks if there's a sqlite_db in the global object. And if there's it will close that in the end of every route/request
...
def index():
    ...
    if request.method == 'POST':
        date = request.form['date'] #assuming the date is YYYY-MM-DD
